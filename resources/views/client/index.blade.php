            ...
            <div class="catalog-slide-content">
                ...
                @guest
                    <div style="display: flex; gap: 15px; flex-wrap: wrap; justify-content: center; margin-top: 20px;">
                        <a href="{{ route('register') }}" class="btn" style="background: var(--white); color: var(--green-dark); padding: 12px 30px; border-radius: 50px; font-weight: 600;">
                            Créer un compte
                        </a>
                        <a href="{{ route('login') }}" class="btn" style="background: transparent; color: var(--white); border: 2px solid var(--white); padding: 12px 30px; border-radius: 50px; font-weight: 600;">
                            Se connecter
                        </a>
                    </div>
                @else
                    <div style="display: flex; gap: 15px; flex-wrap: wrap; justify-content: center; margin-top: 20px;">
                        <a href="{{ Auth::user()->isAdmin() ? route('admin.dashboard') : route('client.index') }}" class="btn" style="background: var(--white); color: var(--green-dark); padding: 12px 30px; border-radius: 50px; font-weight: 600;">
    ...
    <div class="container">
            ...
            <article class="product-card">
                ...
                <div class="product-body">
                    ...
                    <div class="product-footer">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="add-btn" style="background: var(--muted);">🔒 Connexion</a>
                        @endauth
                    </div>
                </div>
            </article>
        ...
        @guest
            <div style="text-align: center; margin-top: 50px; padding: 40px 30px; background: linear-gradient(135deg, #e8f5e9 0%, #c8e6c9 100%); border-radius: 16px; border: 2px solid var(--green);">
                ...
                <p style="color: var(--text); font-size: 16px; max-width: 500px; margin: 0 auto 20px;">
                    Connectez-vous ou créez un compte pour passer votre commande et profiter de nos produits naturels.
                </p>
                <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
                    <a href="{{ route('login') }}" class="btn" style="background: var(--green); color: var(--white); padding: 12px 35px; border-radius: 50px; font-weight: 600; text-decoration: none; display: inline-block;">
                        🔐 Se connecter
                    </a>
                    <a href="{{ route('register') }}" class="btn" style="background: transparent; color: var(--green); border: 2px solid var(--green); padding: 12px 35px; border-radius: 50px; font-weight: 600; text-decoration: none; display: inline-block;">
                        📝 S'inscrire
                    </a>
                </div>
            </div>
