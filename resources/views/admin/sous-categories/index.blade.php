...
<div class="container" style="padding: 40px 0;">
    <div class="row">
        <div class="col-12">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px; flex-wrap: wrap; gap: 15px;">
                <div>
                    <h1 style="font-family: 'Playfair Display', serif; color: #2d5a27; font-size: 2rem; margin: 0;">
                        <i class="fas fa-sitemap" style="color: #b8860b; margin-right: 10px;"></i>
                        Gestion des sous-catégories
                    </h1>
                    <p style="color: #6c757d; margin: 5px 0 0 0;">Gérez les sous-catégories de produits de votre boutique</p>
                </div>
                <a href="{{ route('admin.sous-categories.create') }}" style="
                    background: #2d5a27;
                    color: white;
                    padding: 12px 24px;
                    border-radius: 30px;
            ...
            ">
                <form method="GET" action="{{ route('admin.sous-categories.index') }}" style="display: flex; flex-wrap: wrap; gap: 15px; align-items: flex-end;">
                    ...
                    <div style="flex: 0 0 200px; min-width: 150px;">
                        <label for="category_id" style="display: block; font-weight: 600; color: #2d5a27; font-size: 0.9rem; margin-bottom: 5px;">
                            <i class="fas fa-tag" style="color: #b8860b; margin-right: 5px;"></i> Catégorie
                        </label>
