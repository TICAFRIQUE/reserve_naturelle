...
<div class="container" style="padding: 40px 0;">
    <div class="row">
        <div class="col-12">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px; flex-wrap: wrap; gap: 15px;">
                <div>
                    <h1 style="font-family: 'Playfair Display', serif; color: #2d5a27; font-size: 2rem; margin: 0;">
                        <i class="fas fa-motorcycle" style="color: #2d5a27; margin-right: 10px;"></i>
                        Gestion des livreurs
                    </h1>
                    <p style="color: #6c757d; margin: 5px 0 0 0;">Gérez les livreurs disponibles pour les tournées</p>
                </div>
                <a href="{{ route('admin.livreurs.create') }}" style="
                    background: #2d5a27;
                    color: white;
                    padding: 12px 24px;
                    border-radius: 30px;
            ...
            ">
                <form action="{{ route('admin.livreurs.index') }}" method="GET" style="display: flex; flex-wrap: wrap; gap: 15px; align-items: flex-end;">
                    ...
                    <table style="width: 100%; border-collapse: collapse; font-size: 0.95rem;">
                        <thead style="background: #f8f5f0; border-bottom: 2px solid #e8e0d5;">
                            <tr>
                                ...
                                <th style="padding: 15px 20px; text-align: left; font-weight: 600; color: #2d5a27; width: 15%;">Quartier</th>
                                <th style="padding: 15px 20px; text-align: center; font-weight: 600; color: #2d5a27; width: 13%;">Statut</th>
                            ...
                            @forelse($livreurs as $livreur)
                                <tr style="border-bottom: 1px solid #f0ebe5; transition: background 0.2s;" onmouseover="this.style.background='#faf8f5'" onmouseout="this.style.background='transparent'">
                                    ...
                                    <td style="padding: 15px 20px; color: #2d5a27;">
                                        <a href="tel:{{ $livreur->tel }}" style="color: #2d5a27; text-decoration: none;">
                                    ...
                                    <td style="padding: 15px 20px; color: #6c757d;">{{ $livreur->quartier ?? '—' }}</td>
                                    <td style="padding: 15px 20px; text-align: center;">
                                        ...
                                        @else
                                            <span style="
                                                ...
                                                display: inline-block;
                                            ">
                                                <i class="fas fa-times-circle" style="margin-right: 5px;"></i> Indisponible
                                            </span>
                                        @endif
                                    </td>
                                    <td style="padding: 15px 20px; text-align: center;">
