...
@section('title', 'Modifier ' . $zone->nom . ' - La Réserve Naturelle')
        ...
        <div class="col-12">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px; flex-wrap: wrap; gap: 15px;">
                <div>
                    ...
                    <p style="color: #6c757d; margin: 5px 0 0 0;">
                        ...
                        Mettez à jour les informations de la zone de livraison
                    </p>
                </div>
            ...
            ">
                <div style="display: flex; align-items: center; gap: 12px;">
                    ...
                    <div>
                        <div style="font-weight: 600; color: #2d5a27; font-size: 1.05rem;">{{ $zone->nom }}</div>
                        <div style="color: #6c757d; font-size: 0.85rem;">
                            <i class="fas fa-coins" style="color: #2d5a27;"></i> 
                            {{ number_format($zone->tarif, 0, ',', ' ') }} FCFA
                        </div>
                    </div>
                </div>
                <div style="margin-left: auto; display: flex; gap: 20px;">
                    <div style="text-align: center;">
                        <div style="font-weight: 600; color: #2d5a27; font-size: 0.85rem;">Type</div>
                        @if($zone->est_expedition)
                            <span style="
                                background: #fff3cd;
                                color: #856404;
                                padding: 4px 14px;
                        ...
                        @else
                            <span style="
                                ...
                                margin-top: 2px;
                            ">
                                <i class="fas fa-city"></i> Livraison locale
                            </span>
                        @endif
                    </div>
                    <div style="text-align: center;">
                        ...
                        <div style="color: #6c757d; font-size: 0.8rem; margin-top: 2px;">
                            {{ $zone->created_at instanceof \Carbon\Carbon ? $zone->created_at->format('d/m/Y') : date('d/m/Y', strtotime($zone->created_at)) }}
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div style="margin-bottom: 30px;">
                        ...
                        <div style="display: flex; gap: 15px; flex-wrap: wrap;">
                            ...
                            <label style="
                                ...
                                gap: 10px;
                                padding: 14px 20px;
                                background: {{ old('est_expedition', $zone->est_expedition) == 0 ? '#e8f5e9' : '#faf8f5' }};
                                border: 2px solid {{ old('est_expedition', $zone->est_expedition) == 0 ? '#2d5a27' : '#e8e0d5' }};
                                border-radius: 8px;
                                cursor: pointer;
                                flex: 1;
                                transition: all 0.3s ease;
                            " onmouseover="this.style.borderColor='#2d5a27'" onmouseout="this.style.borderColor='{{ old('est_expedition', $zone->est_expedition) == 0 ? '#2d5a27' : '#e8e0d5' }}'">
                                <input type="radio" name="est_expedition" value="0" {{ old('est_expedition', $zone->est_expedition) == 0 ? 'checked' : '' }} style="width: 18px; height: 18px; accent-color: #2d5a27;">
                                <div>
                            ...
                            <label style="
                                ...
                                gap: 10px;
                                padding: 14px 20px;
                                background: {{ old('est_expedition', $zone->est_expedition) == 1 ? '#fff3cd' : '#faf8f5' }};
                                border: 2px solid {{ old('est_expedition', $zone->est_expedition) == 1 ? '#b8860b' : '#e8e0d5' }};
                                border-radius: 8px;
                                cursor: pointer;
                                flex: 1;
                                transition: all 0.3s ease;
                            " onmouseover="this.style.borderColor='#b8860b'" onmouseout="this.style.borderColor='{{ old('est_expedition', $zone->est_expedition) == 1 ? '#b8860b' : '#e8e0d5' }}'">
                                <input type="radio" name="est_expedition" value="1" {{ old('est_expedition', $zone->est_expedition) == 1 ? 'checked' : '' }} style="width: 18px; height: 18px; accent-color: #b8860b;">
                                <div>
