                ...
                <div style="display: flex; align-items: center; gap: 12px;">
                    ...
                    <div>
                        ...
                        <div style="color: #6c757d; font-size: 0.85rem;">
                            <i class="fas fa-tag" style="color: #2d5a27;"></i> 
                            Réf: {{ $product->reference_prod }}
                        </div>
                    </div>
                </div>
                ...
                <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 25px; margin-bottom: 25px;">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="reference_prod" 
                                   name="reference_prod" 
                                   value="{{ old('reference_prod', $product->reference_prod) }}"
                                   style="
                                       width: 100%;
                                       padding: 12px 16px;
                    ...
                    <div style="margin-bottom: 25px;">
                        ...
                        <input type="number" 
                               id="qte_dispo" 
                               name="qte_dispo" 
                               value="{{ old('qte_dispo', $product->qte_dispo) }}"
                               min="0"
                               style="
                                   width: 100%;
                                   max-width: 300px;
                               ...
                               required>
                        <div style="color: #6c757d; font-size: 0.8rem; margin-top: 5px;">
                            <i class="fas fa-info-circle"></i> Quantité actuelle en stock
                        </div>
                        @error('qte_dispo')
                            <div style="color: #dc3545; font-size: 0.85rem; margin-top: 5px;">
                                <i class="fas fa-exclamation-circle"></i> {{ $message }}
