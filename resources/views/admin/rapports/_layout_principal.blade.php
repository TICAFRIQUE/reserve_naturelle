{{-- resources/views/admin/rapports/_layout_principal.blade.php --}}
{{-- Utilisé UNIQUEMENT par vue-ensemble.blade.php (page d'accueil des rapports) --}}
...
<div class="container" style="padding: 40px 0;">
    <div class="row">
        <div class="col-12">
            @include('admin.rapports._entete')
